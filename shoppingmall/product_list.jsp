...
<%@ page language="java" import="java.sql.*,java.util.*,java.text.*, java.net.URLEncoder"%>
<%
...
<BODY>
			...
			<%
				...
				try {
					...
					//con = DriverManager.getConnection(
						//	"jdbc:mysql://localhost:3306/shop?useUnicode=true&characterEncoding=euc-kr", "root", "1234");
				...
				try {
					...
					if (!(rs.next())) {
						...
						for (int j = startrow; j <= endrow; j++) {
							...
							out.print("&cat=" + ca + "&pname=" + URLEncoder.encode(pn, "UTF-8") + "\">" + pname.elementAt(j));										
							out.println("</A></TD>");
	...
	<FORM method=post name=search action="product_list.jsp">
		<TABLE border=0 width=95%>
			<TR>
				<TD align=center> <INPUT type=text size=50 placeholder="상품명으로 찾기" name=pname>
