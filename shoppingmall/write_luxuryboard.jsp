...
<TABLE border='0' width='600' cellpadding='2' cellspacing='2'>
	<TR>
		...
		<TD><p><input type='text' size='12' name='name'> * 필수</p>
		</TD>
	</TR>
	<TR>
		<TD width='100' bgcolor='cccccc'>
		...
		<TD><p><input type='password' size='12' name='pass'> * 필수
							(게시물 수정 삭제시 필요합니다.)</p>
		</TD>
	</TR>
	<TR>
	...
	<TR>
		...
		<TD>
			<font size='2'><input type='file' name='userFile'>
            </font>
		</TD>
	</TR>
	<TR>
	...
	<TR>
		<TD bgcolor='cccccc'>
			<font size='2'><center><b>글 내용</b></center>
			</font>
		</TD>
		<TD>
			<font size='2'>
